...
Babbler.kModelName = PrecacheAsset("models/marine/shotgun/shotgun.model")
...
if Server then
    ...
    function Babbler:UpdateMove(deltaTime)
        ...
        self:SetAngles(Angles(math.pi*0.5,math.pi*0.5,math.pi*0.5))
        self:SetOrigin(Vector(math.pi*0.5,math.pi*0.5,math.pi*0.5))
