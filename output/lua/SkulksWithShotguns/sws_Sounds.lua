...
kSfxGorgeStolenOur = PrecacheAsset("sound/sws2.fev/common/gorge_stolen_our")
kSfxGorgeStolenTheir = PrecacheAsset("sound/sws2.fev/common/gorge_stolen_their")

kSfxBlueScores = PrecacheAsset("sound/sws2.fev/common/blue_scores")
kSfxRedScores = PrecacheAsset("sound/sws2.fev/common/red_scores")
